...
/*
    ...
    classes/class.Fornitore.php v.1.0.0. 28/05/2020
*/
...
class Fornitori extends Core
{
    ...
    public static function getFornitoreFasceOrdiniFromCode($companies_code = '', $opt = [])
    {
        ...
        if (Core::$resultOp->error > 0) {
            die('errore db get fasceordini fornitore');
    ...
    public static function getFornitoreOrdersFromCodePdoObject($companies_code, $opt = [])
    {
        ...
        if ($companies_code != '') {
            ...
            if (Config::$queryParams['where'] != '') {
                ...
                if (is_array(Config::$queryParams['where'])) {
                    $fv = array_merge($fv, Config::$queryParams['where']);
                }
    ...
    public static function getFornitoriList()
    {
        ...
        if (Core::$resultOp->error > 0) {
            ToolsStrings::redirect(URL_SITE.'error/db');
            die('errore db lettura fornitori');
        }
