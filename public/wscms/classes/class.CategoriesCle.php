...
/*
classes/class.Categories.php v.1.0.0. 27/07/2016
*/
class CategoriesCle extends Core
{
    ...
    public static function getObjFromSubCategories($opz)
    {
        ...
        $ordering = (isset($opz['ordering']) && $opz['ordering'] != '' ? $opz['ordering'] : 'ordering ASC');
