...
/*	classes/class.EcomBasket.php v.3.3.0. 21/06/2017 */
                ...
                foreach ($obj as $value) {
                    ...
                    if (Core::$resultOp->error == 0) {
                        ...
                        if ($match > 0) {
                            ...
                            if (isset($obj->session_basket) && $obj->session_basket != '') {
                                Sql::initQuery($dbprefix.'ec_basket_products', [], [$obj->session_basket], 'session_basket = ?', '');
                            }
                            Sql::deleteRecord();
                        }
                    } else {
