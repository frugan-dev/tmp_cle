...
$App->newsTemplate = '';
if (isset($_MY_SESSION_VARS[$App->sessionName]['newsTemplate']) && $_MY_SESSION_VARS[$App->sessionName]['newsTemplate'] != '') $App->newsTemplate = $_MY_SESSION_VARS[$App->sessionName]['newsTemplate'];
if ($App->newsTemplate == '') {
