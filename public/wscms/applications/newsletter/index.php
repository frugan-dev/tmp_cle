...
if (!isset($_SESSION['newsletter']['newsletter da inviare'])) {
    $_SESSION['newsletter']['newsletter da inviare'] = '';
}
if (!isset($_SESSION['newsletter']['newsletter da inviare finale'])) {
    $_SESSION['newsletter']['newsletter da inviare finale'] = '';
}
