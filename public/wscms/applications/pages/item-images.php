...
switch(Core::$request->method) {
	...
	case 'newIimg':			
		$App->pageSubTitle = preg_replace('/%ITEM%/',(string) Core::$langVars['immagine'],(string) Core::$langVars['inserisci %ITEM%']);
	...
	case 'modifyIimg':		
		$App->pageSubTitle = preg_replace('/%ITEM%/',(string) Core::$langVars['immagine'],(string) Core::$langVars['modifica %ITEM%']);
