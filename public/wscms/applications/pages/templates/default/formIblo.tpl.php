<!-- wscms/pages/formIblo.tpl.php v.3.5.4. 02/04/2019 -->
<div class="row">
...
<div class="card shadow mt-3 mb-4">
	<div class="card-body">
		...
		<ul class="nav nav-tabs" id="formTab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link" href="#other" id="other-tab" data-toggle="tab" role="tab" aria-controls="other" aria-selected="true">{{ Lang['altro']|capitalize }}</a>
			</li>
					...
					<fieldset>
						<div class="form-group row">
							...
							<div class="col-md-7">								
								...
								id="title_{{ lang }}ID" value="{{ attribute(App.item, titleField) }}" oninvalid="this.setCustomValidity('{{ Lang['Devi inserire un %ITEM%!']|replace({'%ITEM%': Lang['titolo']}) }}')" oninput="setCustomValidity('')">
							</div>
						</div>					
						<hr>
						<div class="form-group row">
							...
							<div class="col-md-8">
								<textarea name="content_{{ lang }}" class="form-control editorHTML" id="content_{{ lang }}ID" rows="5" oninvalid="this.setCustomValidity('{{ Lang['Devi inserire un %ITEM%!']|replace({'%ITEM%': Lang['contenuto']}) }}')" oninput="setCustomValidity('')">{{ attribute(App.item, contentField) }}</textarea>
							</div>
						</div>
					</fieldset>				
				</div>
					...
					<fieldset>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
								...
								<a class="" href="{{ App.params.uploadDirs['iblo'] }}{{ App.item.filename }}" data-lightbox="image-1" data-title="{{ value.org_filename }}" title="{{ App.item.org_filename }}">
									<img  class="img-miniature"  src="{{ App.params.uploadDirs['iblo'] }}{{ App.item.filename }}" alt="{{ App.item.org_filename }}">
								</a>							
								{% else %}
...
<div class="tab-pane" id="other" role="tabpanel" aria-labelledby="other-tab">						
					<fieldset>											
						...
						<div class="form-group row">
							<label for="targetID" class="col-md-2 control-label">{{ Lang['target']|capitalize }}</label>
							<div class="col-md-4">							
...
<!-- sezione opzioni -->			
			...
			<div class="form-group row">
				...
				<div class="col-md-6 col-xs-12 text-right">			
					<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listIblo" title="{{ Lang['torna alla lista']|capitalize }}" class="btn btn-success">{{ Lang['indietro']|capitalize }}</a>
				</div>
			</div>
