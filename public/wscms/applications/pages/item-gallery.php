...
/* wscms/news/item-gallery.php v.3.5.3. 10/07/2018 */
...
switch ((string)$App->viewMethod) {
    ...
    case 'formNew':
        ...
        $App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications.Core::$request->action.'/templates/'.$App->templateUser.'/js/formIgal.js"></script>';
        break;
    ...
    case 'list':
        ...
        $App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications.Core::$request->action.'/templates/'.$App->templateUser.'/js/listIgal.js"></script>';
        break;
