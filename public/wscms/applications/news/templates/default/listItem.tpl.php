<!-- news/listItem.tpl.php v.2.6.3. 06/04/2016 -->
<div class="row">
						...
						{% if App.items is iterable and App.items|length > 0 %}
							{% for key,value in App.items %}						
								<tr>
									...
									{% endif %}
									<td>{{ value.datatimeins|date("d/m/Y H:i:s") }}</td>
									...
									<td class="ordering">										
										<a class="btn btn-default btn-circle" href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/listIfil/<?php echo $value->id; ?>" title="File associati"><i class="fas fa-file"></i></a>
										&nbsp;({{ value.files }})										
									</td>	
																			

									<td class="actions">
										<a class="btn btn-default btn-sm" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/{{ value.active == 1 ? 'disactive' : 'active' }}Item/{{ value.id  }}" title="{{ value.active == 1 ? Lang['disattiva']|capitalize : Lang['attiva']|capitalize }} {{ Lang['voce'] }}"><i class="fa fa-{{ value.active == 1 ? 'unlock' : 'lock' }}"></i></a>			 
										...
										<a class="btn btn-default btn-sm confirm" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/deleteItem/{{ value.id }}" title="{{ Lang['cancella']|capitalize }} {{ Lang['voce'] }}"><i class="far fa-trash-alt"></i></a>
									</td>		
