...
switch (Core::$request->method) {
    ...
    case 'insertTeam':
        ...
        if (!isset($_POST['ordering']) || (isset($_POST['ordering']) && $_POST['ordering'] == 0)) {
            $_POST['ordering'] = Sql::getMaxValueOfField($App->params->tables['team'], 'ordering', '') + 1;
        }
    ...
    case 'updateTeam':
        ...
        if ($_POST['filename'] == '' && $App->oldItem->filename != '') {
            $_POST['filename'] = $App->oldItem->filename;
        }
        if ($_POST['org_filename'] == '' && $App->oldItem->org_filename != '') {
            $_POST['org_filename'] = $App->oldItem->org_filename;
        }
