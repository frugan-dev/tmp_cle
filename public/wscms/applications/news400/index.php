...
switch (substr((string) Core::$request->method, -4, 4)) {
    case 'Iimg':
        ...
        if (!isset($_MY_SESSION_VARS[$App->sessionName]['page'])) {
            $_MY_SESSION_VARS = $my_session->addSessionsModuleVars($_MY_SESSION_VARS, $App->sessionName, ['page' => 1,'ifp' => '10','srcTab' => '','id_owner' => '0']);
        }
    ...
    default:
        ...
        if (!isset($_MY_SESSION_VARS[$App->sessionName]['page'])) {
            $_MY_SESSION_VARS = $my_session->addSessionsModuleVars($_MY_SESSION_VARS, $App->sessionName, ['page' => 1,'ifp' => '10','srcTab' => '','id_cat' => 0]);
        }
