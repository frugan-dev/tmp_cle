<!--  wscms/site-pages/listIfil.tpl.php v.1.0.1. 07/09/2016  -->
<div class="row">
	...
	<div class="col-md-2">
 		<a href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/list" title="Torna alla lista <?php echo $this->App->labels['ifil']['owners']; ?>" class="btn btn-primary">Lista <?php echo $this->App->labels['ifil']['owners']; ?></a>
	</div>
</div>
                                ...
                                foreach ($this->App->items as $key => $value):
									...
									<tr>
										...
										<td class="ordering">
											...
											<?php endif; ?>							
											<a class="" href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/<?php echo($this->App->orderingType == 'ASC' ? 'less' : 'more'); ?>OrderingIfil/<?php echo $value->id; ?>" title="Sposta sù"><i class="fa fa-long-arrow-up"> </i>&nbsp;</a>
											&nbsp;
											<a class="" href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/<?php echo($this->App->orderingType == 'ASC' ? 'more' : 'less'); ?>OrderingIfil/<?php echo $value->id; ?>" title="Sposta giu"><i class="fa fa-long-arrow-down"> </i>&nbsp;</a>
										</td>										
										<td><?php echo SanitizeStrings::htmlout($value->title_it); ?></a></td>
										<td>	
