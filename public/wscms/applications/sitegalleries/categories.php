                    ...
                    if ($oldCate_name == $newCate_name || ($oldCate_name != $newCate_name && $count == 0)) {
                        ...
                        if (Core::$resultOp->error == 0) {
                            ...
                            if (Core::$resultOp->error == 0) {
                                ...
                                if ($oldCate_name != '') {
                                    if ($oldCate_name != '' && file_exists($App->itemUploadPathDir.$oldCate_name)) {
                                        rename($App->itemUploadPathDir.$oldCate_name, $App->itemUploadPathDir.$newCate_name) or die('impossibile rinominare la cartella');
                                    }
                                }
