...
/*
    ...
    partners/items.php v.2.6.3. 21/04/2016
*/
            ...
            if (Core::$resultOp->error == 0) {
                ...
                if (Core::$resultOp->error == 0) {
                    ...
                    if (Core::$resultOp->error == 0) {
                        ...
                        if (Core::$resultOp->error == 0) {
                            if ($uploadFilename != '') {
                                move_uploaded_file(ToolsUpload::getTempFilename(), $App->params->itemUploadPathDir.$uploadFilename) or die('Errore caricamento file');
