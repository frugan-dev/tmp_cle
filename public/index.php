...
if (file_exists(PATH.'templates/'.$App->templateUser.'/configuration.inc.php')) {
    include_once(PATH.'templates/'.$App->templateUser.'/configuration.inc.php');
}

/* aggiorna la config */
Config::setGlobalSettings($globalSettings);

if (file_exists(PATH.'pages/site_init.php')) {
    include_once(PATH.'pages/site_init.php');
}
...
if (file_exists(PATH.'pages/site_main.php')) {
    include_once(PATH.'pages/site_main.php');
}
