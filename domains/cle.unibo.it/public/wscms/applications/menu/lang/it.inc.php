...
Config::$langVars = array_merge(Config::$langVars, array(
    ...
    'menu-type-vars' => array (
        'menupages'=>array('varreplace'=>'%MENUPAGES%','title'=>'Il menu pagine dinamiche','info'=>'Il menu generato dal modulo pages è in genere il menu principale del sito, dove vengono mostrate nel menu le pagine dinamiche gestite dal modulo stesso'),
        'menuvecchiepages'=>array('varreplace'=>'%MENUPAGESOLD%','title'=>'Il menu vecchie pagine dinamiche','info'=>'Il menu generato dal vecchio ed obsoleto modulo Pagine ecchio è in genere il menu mantenuto per compatibilità dei vecchi contenuti, dove vengono mostrate nel menu le pagine dinamiche gestite dal modulo stesso'),
