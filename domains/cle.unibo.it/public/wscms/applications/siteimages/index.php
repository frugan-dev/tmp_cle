<?php
/* wscms/site-images/index.php v.1.0.0. 22/06/2016 */
...
$tableFold = $App->params->tableFold;
$fieldsFold = $App->params->fieldsFold;
...
switch(substr(Core::$request->method,-4,4)) {	
	case 'Fold':
		...
		$Module = new Module(Core::$request->action,$tableFold);
