...
<div class="card shadow mt-3 mb-4">
	<div class="card-body">
		...
		<ul class="nav nav-tabs" id="formTab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link" href="#file" id="file-tab" data-toggle="tab" role="tab" aria-controls="file" aria-selected="true">{{ Lang['file']|capitalize }}</a>
			</li>
		...
		<form id="applicationForm" class="form-horizontal" role="form" action="{{ URLSITEADMIN }}{{ CoreRequest.action }}/{{ App.methodForm }}"  enctype="multipart/form-data" method="post">
							...
							<fieldset>
								<div class="form-group row">
									...
									<div class="col-md-7">
										...
										id="title_{{ lang }}ID" rows="3" value="{{ attribute(App.item, titleField)|e('html') }}">
									</div>
								</div>
								<!-- <hr>
								<div class="form-group row">
					...
					<fieldset>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
								...
								<a class="" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/downloadIfil/{{ App.item.id }}" title="{{ Lang['scarica il file']|capitalize }} {{ App.item.org_filename }}">
									{{ App.item.filename }}
								</a>							
								{% endif %}
							</div>			
			...
			<div class="form-group row">
				...
				<div class="col-md-6 col-xs-12 text-right">				
					<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listIfil" title="{{ Lang['torna alla lista']|capitalize }}" class="btn btn-success">{{ Lang['indietro']|capitalize }}</a>
				</div>
			</div>
		</form>
	</div>
