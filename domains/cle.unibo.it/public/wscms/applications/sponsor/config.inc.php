...
Sql::initQuery(DB_TABLE_PREFIX.'modules',array('help_small','help'),array('sponsor'),'name = ?');
$obj = Sql::getRecord();
...
$App->params->labels['item'] = array('item'=>'sponsor','itemSex'=>'o','items'=>'sponsor','itemsSex'=>'i','owner'=>'Categoria','ownerSex'=>'a','owners'=>'Categorie','ownersSex'=>'e');
$App->params->labels['cate'] = array('item'=>'categoria','itemSex'=>'a','items'=>'categorie','itemsSex'=>'e','son'=>'partner','sonSex'=>'o','sons'=>'sponsor','sonsSex'=>'i','owner'=>'','ownerSex'=>'','owners'=>'','ownersSex'=>'');
$App->params->labels['ifil'] = array('item'=>'file','itemSex'=>'o','items'=>'files','itemsSex'=>'i','owner'=>'sponsor','ownerSex'=>'a','owners'=>'notizie','ownersSex'=>'e');
