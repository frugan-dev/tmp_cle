<!-- wscms/site-pageslist/listItem.tpl.php 07/06/2016 -->
<div class="row">
	<div class="col-md-3 new">
		<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/newItem" title="{{ Lang['inserisci un nuovo %ITEM%']|replace({'%ITEM%':Lang['blocco'] })|capitalize }}" class="btn btn-sm btn-primary">{{ Lang['nuovo %ITEM%']|replace({'%ITEM%':Lang['blocco'] })|capitalize }}</a>
	</div>
	...
	<div class="card-body">
		...
		<form role="form" action="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listItem" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				<label for="categories_idID" class="col-sm-12 col-md-4 col-lg-3 col-xl-2 col-form-label">{{ Lang['pagina']|capitalize }}</label>
							...
							{% for key,value in App.items %}
								<tr>
									...
									<td class="ordering">
										...
										{% endif %}							
										<a class="" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/{{ App.params.orderingItemType == 'DESC' ? 'less' : 'more' }}OrderingItem/{{ value.id }}" title="{{ Lang['sposta']|capitalize }} {{ App.params.orderingItemType == 'DESC' ? Lang['su'] : Lang['giu'] }}"><i class="fas fa-long-arrow-alt-down"></i></a>
										<a class="" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/{{ App.params.orderingItemType == 'DESC' ? 'more' : 'less' }}OrderingItem/{{ value.id }}" title="{{ Lang['sposta']|capitalize }} {{ App.params.orderingItemType == 'DESC' ? Lang['giu'] : Lang['su'] }}"><i class="fas fa-long-arrow-alt-up"></i></a>								
									</td>								
