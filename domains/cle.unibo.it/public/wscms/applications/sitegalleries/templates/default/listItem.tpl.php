<!-- wscms/site-galleries/listImages.tpl.php 09/06/2016 -->
<div class="row">
	...
	<div class="card-body">
		...
		<form role="form" action="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listItem" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				<label for="categories_idID" class="col-sm-12 col-md-4 col-lg-3 col-xl-2 col-form-label">{{ Lang['galleria']|capitalize }}</label>
