<!-- wscms/news/formIimg.tpl.php v.3.5.3. 19/09/2018 -->
<div class="row">
				...
				<div class="tab-pane{% if lang == Lang['user'] %} active{% endif %}" id="datibase{{ lang }}-tab">
					<fieldset class="form-group">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input{% if lang == Lang['user'] %} required{% endif %} type="text" class="form-control" name="title_{{ lang }}" placeholder="{{ Lang['inserisci un titolo']|capitalize }} {{ lang }}" id="title_{{ lang }}ID" value="{{ attribute(App.item, titleField) }}">
							</div>
						</div>
						<!-- <hr>
						<div class="form-group">
