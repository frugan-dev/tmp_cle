<!-- wscms/news/formIfil.tpl.php v.3.5.4. 03/04/2019 -->
<div class="row">
...
<div class="row well well-sm">	
	...
	<div class="col-md-2"> 
		...
		<a class="" href="{{ App.params.uploadDirs['item'] }}{{ App.ownerData.filename }}" data-lightbox="image-1" data-title="{{ App.ownerData.org_filename }}" title="{{ App.ownerData.org_filename }}">
			<img class="img-thumbnail" style="max-height:90px;" src="{{ App.params.uploadDirs['item'] }}{{ App.ownerData.filename }}" alt="{{ App.ownerData.org_filename }}">
		</a>
		{% else %}
...
<div class="col-md-7">
<input type="text"{% if lang == 'it' %} required{% endif %} class="form-control" name="title_{{ lang }}" placeholder="{{ Lang['inserisci un titolo']|capitalize }} {{ lang }}" id="title_{{ lang }}ID" value="{{ attribute(App.item, titleField)|e('html') }}" 
oninvalid="this.setCustomValidity('{{ Lang['Devi inserire un %ITEM%!']|replace({'%ITEM%': Lang['titolo']}) }}')" oninput="setCustomValidity('')">
							</div>						</div>
						<hr>
						<div class="form-group">
...
<!-- sezione opzioni --> 
			...
			<hr>		
			<div class="form-group">
				<div class="col-md-offset-2 col-md-7 col-xs-offset-0 col-xs-12">
