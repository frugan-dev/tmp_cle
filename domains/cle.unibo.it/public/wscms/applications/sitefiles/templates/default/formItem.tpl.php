<!-- wscms/site-files/formFiles.tpl.php v.1.0.0. 22/06/2016 -->
<div class="row">
				...
				<div class="tab-pane active" id="datibase-tab">
					...
					<fieldset>
						...
						<div class="form-group row">
							...
							<div class="col-md-7">								
								<select class="form-control input-md" name="id_folder">									
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
									...
									{% if App.item.filename is defined and App.item.filename != '' %}
										{{ App.params.itemUploadDir }}{{ App.item.folder_name }}{{ App.item.filename }}
									{% endif %}			
