<!-- wscms/news/formItem.tpl.php 06/06/2016 -->
<div class="row">
...
<div class="card shadow mt-3 mb-4">
	<div class="card-body">
		...
		<ul class="nav nav-tabs" id="formTab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link" href="#data" data-toggle="tab" role="tab" aria-controls="data" aria-selected="false">Data</a>
			</li>
			{% for lang in GlobalSettings['languages'] %}			
				<li class="nav-item">
					<a class="nav-link" href="#datibase{{ lang }}" data-toggle="tab" role="tab" aria-controls="help" aria-selected="false">Dati Base {{ lang }}</a>
				</li>
			{% endfor %}
			<li class="nav-item">
		  ...
		  <form id="applicationForm" class="form-horizontal" role="form" action="{{ URLSITEADMIN }}{{ CoreRequest.action }}/{{ App.methodForm }}"  enctype="multipart/form-data" method="post">
			...
			<div class="tab-content">
				<!-- sezione data --> 	
				<div class="tab-pane fade show active" id="data" role="tabpanel" aria-labelledby="data">
					<fieldset>				
						<div class="row">
							<label for="datatimeinsID" class="col-md-2 control-label">Data</label>
							<div class="col-sm-3">
								<div class="form-group">
									<div class="input-group date" id="datatimeinsID" data-target-input="nearest">
										<input type="text" class="form-control datetimepicker-input" data-target="#datatimeinsID" name="datatimeins" />
										<div class="input-group-append" data-target="#datatimeinsID" data-toggle="datetimepicker">
				...
				<div class="tab-pane fade" id="datibase{{ lang }}" role="tabpanel" aria-labelledby="datibase{{ lang }}">
					...
					<fieldset>
						...
						<div class="form-group row">
							<label for="summary_{{ lang }}ID" class="col-sm-12 col-md-12 col-lg-2 col-xl-2 col-form-label">Sommario {{ lang }} </label>
							<div class="col-sm-12 col-md-6 col-lg-8 col-xl-8">
								<textarea 
								name="summary_{{ lang }}" 
								class="form-control" 
				...
				<div class="tab-pane fade" id="video" role="tabpanel" aria-labelledby="video">
					...
					<fieldset>
						<div class="form-group row">
							<label for="embeddedID" class="col-md-2 control-label">Codice embedded</label>
							<div class="col-md-7" id="embeddedID">
								<textarea name="embedded" class="form-control" placeholder="Inserisci una codice video embedded" id="embeddedID" rows="5">{{ App.item.embedded|raw }}</textarea>	
					    	</div>
						</div>
					</fieldset>	
				</div>
			...
			<div class="form-group row">
				<div class="col-md-6 col-xs-12 text-center">
					...
					<input type="hidden" name="id_cat" id="id_catID" value="{{ App.id_cat }}">
