...
Sql::initQuery(DB_TABLE_PREFIX.'modules',['name','help_small','help'],['site-pages'],'name = ?');
$obj = Sql::getRecord();
...
$App->params->labels['item'] = ['item'=>'pagina','itemSex'=>'a','items'=>'pagine','itemsSex'=>'e','owner'=>'Categoria','ownerSex'=>'a','owners'=>'Categorie','ownersSex'=>'e'];
...
$App->params->labels['ifil'] = ['item'=>'file','itemSex'=>'o','items'=>'files','itemsSex'=>'i','owner'=>$App->params->labels['item']['item'],'ownerSex'=>$App->params->labels['item']['itemSex'],'owners'=>$App->params->labels['item']['items'],'ownersSex'=>$App->params->labels['item']['itemsSex']];
...
$App->params->fields = [
	...
	'id_template'=>['label'=>'Template','searchTable'=>false,'required'=>false,'type'=>'int'],
	'type'=>['label'=>'Tipo','searchTable'=>false,'required'=>false,'type'=>'varchar'],
	'ordering'=>['label'=>'Ordinamento','searchTable'=>false,'required'=>false,'type'=>'int'],
	'menu'=>['label'=>'In menu?','searchTable'=>false,'required'=>false,'type'=>'int'],
	...
	'updated'=>['label'=>'Aggiornamento','searchTable'=>false,'required'=>false,'type'=>'datatime'],
...
foreach($globalSettings['languages'] AS $lang) {
	...
	$App->params->fields['title_meta_'.$lang] = ['label'=>'Titolo META '.$lang,'searchTable'=>$searchTable,'required'=>false,'type'=>'varchar'];
	$App->params->fields['title_seo_'.$lang] = ['label'=>'Titolo SEO '.$lang,'searchTable'=>$searchTable,'required'=>false,'type'=>'varchar'];
	$App->params->fields['title_'.$lang] = ['label'=>'Titolo '.$lang,'searchTable'=>$searchTable,'required'=>$required,'type'=>'varchar'];
	$App->params->fields['subtitle_'.$lang] = ['label'=>'Subtitolo '.$lang,'searchTable'=>$searchTable,'required'=>false,'type'=>'varchar'];
	}
...
$App->params->typePage = ['default'=>'Default','label'=>'Etichetta','url'=>'URL','module'=>'Link a modulo'];
